...
#%%
# load the images
folder_path2 = ".\\DATASET - BMP\\237-15PAP_40x_1024_1024_processed\\"
folder_path4 = ".\\DATASET - BMP\\273-17P_40x_1024_1024_processed\\"
folder_path6 = ".\\DATASET - BMP\\546-14 Giemse_40x_1024_1024_processed\\"
...
# 40X 
ReadImages(folder_path2, images, image_names)
ReadImages(folder_path4, images, image_names)
ReadImages(folder_path6, images, image_names)

print("all images imported")

#%% load labels
label_path2 = ".\\237-15PAP_40x_labels_processed.txt"
label_path4 = ".\\273-17P_40x_labels_processed.txt"
label_path6 = ".\\546-14 Giemse_40x_labels_processed.txt"

labels = []

# 40X
ReadLabels(label_path2, labels)
ReadLabels(label_path4, labels)
ReadLabels(label_path6, labels)
...
history = model.fit(x_train, y_train.T[0], epochs=20, batch_size=64, callbacks=[kerasboard])
...
with open("./model_save_40X_BGR.json", "w") as json_file:
    json_file.write(model_json)

# serialize weights to HDF5
model.save_weights("./model_save_40X_BGR.h5")


#%% model load

json_file = open('./model_save_40X_BGR.json', 'r')

loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)

loaded_model.load_weights("./model_save_40X_BGR.h5")
